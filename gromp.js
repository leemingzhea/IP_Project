...
function addToCart() {
    ...
    var productName = document.getElementById("gromp").innerText;
    var productPrice = parseFloat(document.getElementById("gromp-price").innerText.replace("$", "")); // Convert to number and remove the "$" symbol
    var productImage = document.getElementById("gromp-img").src;
