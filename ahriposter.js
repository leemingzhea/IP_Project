...
function addToCart() {
    ...
    var productName = document.getElementById("ahri").innerText;
    var productPrice = parseFloat(document.getElementById("ahri-price").innerText.replace("$", "")); // Convert to number and remove the "$" symbol
    var productImage = document.getElementById("ahri-img").src;
