...
function addToCart() {
    ...
    var productName = document.getElementById("tshirt").innerText;
    var productPrice = parseFloat(document.getElementById("tshirt-price").innerText.replace("$", "")); // Convert to number and remove the "$" symbol
    var productImage = document.getElementById("tshirt-img").src;
