...
function addToCart() {
    ...
    var productName = document.getElementById("zoe").innerText;
    var productPrice = parseFloat(document.getElementById("zoe-price").innerText.replace("$", "")); // Convert to number and remove the "$" symbol
    var productImage = document.getElementById("zoe-img").src;
