...
function addToCart() {
    ...
    var productName = document.getElementById("poro").innerText;
    var productPrice = parseFloat(document.getElementById("poro-price").innerText.replace("$", "")); // Convert to number and remove the "$" symbol
    var productImage = document.getElementById("poro-img").src;
